...
$\nu_1:S\to S_1$ which is an isomorphism on $S-E$ and such that $E$ maps to a point. \item Since $K_S=\nu_1^*K_{S_1}+E$, we have $\mathfrak{R}(K_S)\cong
\mathfrak{R}(K_{S_1})$.
...
\end{cor}
\begin{itemize}\item Proof: Assume that $X$ is of general type.
...
\item After running a MMP with scaling, we may assume that $K_X+\Delta$ is nef.\item By the base-point free theorem, there is a morphism 
